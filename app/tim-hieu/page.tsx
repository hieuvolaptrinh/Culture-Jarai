  ...
  return (
    <PageTransition>
      <main className="min-h-screen bg-background text-foreground">
        ...
        <section className="relative flex flex-col items-center text-center px-8 md:px-16 py-32 overflow-hidden border-b border-border">
          <motion.div
            className="max-w-5xl"
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
              ...
              thiên nhiên hùng vĩ. **Khám phá hành trình nghìn năm của một nền
              văn minh giữa đại ngàn.**
            </p>
          </motion.div>
        </section>
