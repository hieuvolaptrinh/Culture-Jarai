...
export function JraiTextilePattern({
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="absolute top-0 right-0 w-[900px] h-[900px] rounded-full blur-[150px]"
        style={{
          background:
            "radial-gradient(circle, rgb(var(--color-primary) / 0.15), transparent 70%)",
        }}
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.4, 0.7, 0.4],
      ...
      <motion.div
        className="absolute bottom-0 left-0 w-[800px] h-[800px] rounded-full blur-[150px]"
        style={{
          background:
            "radial-gradient(circle, rgb(var(--color-secondary) / 0.15), transparent 70%)",
        }}
        animate={{
          scale: [1.2, 1, 1.2],
          opacity: [0.3, 0.6, 0.3],
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle, rgb(var(--color-accent) / 0.12), transparent 70%)",
        }}
        animate={{
          scale: [1, 1.3, 1],
          opacity: [0.2, 0.5, 0.2],
      ...
      <motion.div
        ...
        style={{
          background:
            "linear-gradient(45deg, transparent 30%, rgb(var(--color-primary) / 0.03) 50%, transparent 70%)",
        }}
        animate={{
